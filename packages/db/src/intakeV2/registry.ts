...
export const V2_SECTIONS: V2SectionDef[] = [
  ...
  { id: 'about',           title: 'About you',                   estimateMinutes: 3 },
  { id: 'care_in_place',   title: 'Care already in place',       estimateMinutes: 2 },
  { id: 'concerns',        title: 'What brings you here',        estimateMinutes: 3, intro: 'Your own words first. Lists come later.' },
  { id: 'medical_history', title: 'Your medical history',        estimateMinutes: 3 },
  { id: 'medication',      title: 'Medication',                  estimateMinutes: 2 },
  { id: 'supplements',     title: 'Supplements & natural remedies', estimateMinutes: 2 },
  { id: 'family',          title: 'Family health',               estimateMinutes: 3, optional: true },
  { id: 'early_life',      title: 'Early life & past health',    estimateMinutes: 2, optional: true },
  { id: 'systems_overview', title: 'A quick check across your body', estimateMinutes: 2 },
  { id: 'digestion',       title: 'Digestion',                   estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Digestion'] } },
  { id: 'nervous',         title: 'Head, nerves & senses',       estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Head, nerves & senses'] } },
  { id: 'sleep',           title: 'Sleep',                       estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Sleep'] } },
  { id: 'mood_stress',     title: 'Mood & stress',               estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Mood & stress'] } },
  { id: 'energy_metabolic', title: 'Energy, hormones & metabolism', estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Energy, hormones & metabolism'] } },
  { id: 'reproductive',    title: 'Reproductive health',         estimateMinutes: 3, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Reproductive health'] }, optional: true },
  { id: 'immune',          title: 'Immune system & allergies',   estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Immune system & allergies'] } },
  { id: 'breathing',       title: 'Breathing, sinuses, throat & ears', estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Breathing, sinuses, throat & ears'] } },
  { id: 'urinary',         title: 'Urinary',                     estimateMinutes: 1, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Urinary'] } },
  { id: 'heart',           title: 'Heart & circulation',         estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Heart & circulation'] } },
  { id: 'muscles_joints',  title: 'Muscles & joints',            estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Muscles & joints'] } },
  { id: 'skin',            title: 'Skin, hair & nails',          estimateMinutes: 2, showIf: { questionId: 'v2.systems.noticed', includesAny: ['Skin, hair & nails'] } },
  { id: 'food_diary',      title: 'What you actually eat',       estimateMinutes: 3, optional: true },
  { id: 'food_frequency',  title: 'How often foods appear',      estimateMinutes: 2 },
  { id: 'eating_habits',   title: 'Eating habits & your kitchen', estimateMinutes: 3 },
  { id: 'drinks',          title: 'Drinks',                      estimateMinutes: 1 },
  { id: 'lifestyle',       title: 'Life & routine',              estimateMinutes: 2 },
  { id: 'timeline',        title: 'Your timeline',               estimateMinutes: 2, optional: true },
  { id: 'review',          title: 'Read it back',                estimateMinutes: 2 },
]
