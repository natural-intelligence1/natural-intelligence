    ...
    <div className="space-y-7">
      ...
      <div className="bg-surface-muted border border-border-default rounded-xl p-5">
        ...
        <p className="text-xs text-text-secondary leading-relaxed mb-4">
          Natural Intelligence will use the information you&apos;ve provided — along with any lab report data and symptom pattern summaries — to generate a personalised health synopsis using AI.
