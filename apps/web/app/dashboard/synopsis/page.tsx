  ...
  if (!hasSynopsis) {
    ...
    return (
      <div className="max-w-2xl mx-auto">
        ...
        <GeneratingState
          storageKey="gen.synopsis"
          title="Generating your synopsis…"
          description="We're reading the signals you've shared and building your personalised overview."
          failureHeading="We couldn't put this together this time."
          failureBody="You can try again, or come back later."
          retryLabel="Try again"
          generateLabel="Regenerate now"
